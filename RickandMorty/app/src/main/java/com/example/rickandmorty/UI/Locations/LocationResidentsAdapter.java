...
public class LocationResidentsAdapter extends RecyclerView.Adapter<LocationResidentsAdapter.ResidentViewHolder> {

    private List<TheCharacter> residents;
    private final OnItemClickListener clickListener;


    public LocationResidentsAdapter(List<TheCharacter> residents, @Nullable OnItemClickListener clickListener) {
    ...
    public ResidentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.location_resident_item, parent, false);
